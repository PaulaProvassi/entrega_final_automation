...
class InventoryPage:
    def __init__(self, driver):
        ...
        self.nombre_producto = (By.CLASS_NAME, "inventory_item_name")
    ...
    def agregar_al_carrito(self):
        self.driver.find_elements(*self.add_to_cart_buttons)[0].click()  # Agrega el primer producto al carrito
    ...
    def obtener_nombre_primer_producto(self):
        return self.driver.find_elements(*self.nombre_producto)[0].text
    ...
    def agregar_producto_por_nombre(self, nombre_producto_json):
        ...
        for producto in productos:
            nombre = producto.find_element(*self.nombre_producto).text
